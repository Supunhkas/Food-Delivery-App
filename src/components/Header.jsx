        ...
        <div className="flex items-center gap-8">
          ...
          <div className="relative ">
            <motion.img
              ...
              alt="avatar"
              className="w-10 min-[40px] h-10 min-[40px] drop-shadow-2xl cursor-pointer rounded-full"
              onClick={login}
            />
            {isMenu && (
              <motion.div
                ...
                className=" w-40 bg-gray-50 shadow-xl rounded-lg flex flex-col absolute px-4 py-5 top-12 right-0"
              >
        ...
        <div className="relative ">
          ...
          {isMenu && (
            ...
            >
              ...
              <p
                className="m-2 p-2 rounded-md shadow-md flex items-center justify-center gap-3 cursor-pointer bg-gray-200 hover:bg-slate-300 transition-all duration-100 ease-in-out"
                onClick={logout}
              >
                Log out <MdLogout />
              </p>
