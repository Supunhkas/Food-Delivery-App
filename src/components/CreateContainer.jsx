...
const CreateContainer = () => {
  ...
  const [aletStatus, setAlertStatus] = useState("danger");
      ...
      <div className=" w-[90%] md:w-[75%] border border-gray-200 rounded-lg p-4 flex flex-col items-center justify-center gap-4">
        {fields && (
          <motion.p
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className={`w-full p-2 rounded-lg text-center text-lg font-semibolds ${
              aletStatus === "danger"
                ? "bg-red-400 text-red-800"
                : "bg-emerald-400 text bg-black-800"
            }`}
          >
            {msg}
          </motion.p>
        ...
        <div className="w-full ">
          <select
            ...
            className="outline-none w-full text-base border-b-2 p-2 rounded-md cursor-pointer "
          >
